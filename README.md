...
By the end of Sprint 3, the team will have a functional game.

-----

# Backlog / Sprint-3 Backlog
...
User stories:
- *As a beginner, I want to be able to play a game against an easy opponent.*
- *As an advanced player, I want to have a challenge.*
...
The group presentation and sprint 3 review can be found in the PowerPoint presentation that we presented on Friday 13.2.26.

[Presentation](https://metropoliafi-my.sharepoint.com/:p:/g/personal/leolee_metropolia_fi/IQAMH4LyaQVESZtJQcPjs__1ARifJfTDqymY-wyRgnxaEe0)

Daily scrum meetings were held daily on weekdays just like for sprint 2.

Sprint retrospective with the 4Ls format

- Liked: authentication, conditional routing.

- Learned: conditional routing, stockfish.

- Lacked: [object Object], time.
